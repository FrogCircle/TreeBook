 ...
 */
.controller('TreesController', ['$scope', '$resource','$stateParams', 'Trees', 'TreeData', 'Search', 'GeoCode', 'Global', 'Likes',
  function($scope, $stateParams, $resource, Trees, TreeData, Search, GeoCode, Global, Likes, Search) {
    $scope.likes = [];
